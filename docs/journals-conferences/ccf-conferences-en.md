...
| :--- | :-------------- | :----------------------------------------------------------- | :--- | :--- | :------------------------------------- |
| 1    | PPoPP           | ACM SIGPLAN Symposium on Principles & Practice of Parallel Programming | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 2    | FAST            | Conference on File and Storage Technologies                  | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 3    | DAC             | Design Automation Conference                                 | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 4    | HPCA            | High Performance Computer Architecture                       | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 5    | MICRO           | IEEE/ACM International Symposium on Microarchitecture        | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 6    | SC              | International Conference for High Performance Computing, Networking, Storage, and Analysis | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 7    | ASPLOS          | International Conference on Architectural Support for Programming Languages and Operating Systems | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 8    | ISCA            | International Symposium on Computer Architecture             | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 9    | USENIX ATC      | USENIX Annul Technical Conference                            | A    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 1    | SoCC            | ACM Symposium on Cloud Computing                             | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 2    | SPAA            | ACM Symposium on Parallelism in Algorithms and Architectures | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 3    | PODC            | ACM Symposium on Principles of Distributed Computing         | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 4    | FPGA            | ACM/SIGDA International Symposium on Field-Programmable Gate Arrays | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 5    | CGO             | Code Generation and Optimization                             | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 6    | DATE            | Design, Automation & Test in Europe                          | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 7    | EuroSys         | European Conference on Computer Systems                      | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 8    | HOT CHIPS       | Hot Chips: A Symposium on High Performance Chips             | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 9    | CLUSTER         | IEEE International Conference on Cluster Computing           | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 10   | ICCD            | International Conference on Computer Design                  | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 11   | ICCAD           | International Conference on Computer-Aided Design            | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 12   | ICDCS           | International Conference on Distributed Computing Systems    | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 13   | CODES+ISSS      | International Conference on Hardware/Software Co-design and System Synthesis | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 14   | HiPEAC          | International Conference on High Performance and Embedded Architectures and Compilers | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 15   | SIGMETRICS      | International Conference on Measurement and Modeling of Computer Systems | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 16   | PACT            | International Conference on Parallel Architectures and Compilation Techniques | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 17   | ICPP            | International Conference on Parallel Processing              | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 18   | ICS             | International Conference on Supercomputing                   | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 19   | VEE             | International Conference on Virtual Execution Environments   | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 20   | IPDPS           | International Parallel & Distributed Processing Symposium    | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 21   | Performance     | International Symposium on Computer Performance Modeling, Measurements and Evaluation | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 22   | HPDC            | International Symposium on High Performance Distributed Computing | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 23   | ITC             | International Test Conference                                | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 24   | LISA            | Large Installation System Administration Conference          | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 25   | MSST            | Mass Storage Systems and Technologies                        | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
| 26   | RTAS            | Real-Time and Embedded Technology and Applications Symposium | B    | 会议 | 计算机体系结构/并行与分布计算/存储系统 |
...
| 7    | MobiHoc         | International Symposium on Mobile Ad Hoc Networking and Computing | B    | 会议 | 计算机网络                             |
...
| 10   | PKC             | International Workshop on Practice and Theory in Public Key Cryptography | B    | 会议 | 网络与信息安全                         |
...
| 2    | ETAPS           | European Joint Conferences on Theory and Practice of Software | B    | 会议 | 软件工程/系统软件/程序设计语言         |
...
| 19   | SPIN            | International SPIN Workshop on Model Checking Software       | C    | 会议 | 软件工程/系统软件/程序设计语言         |
...
| 3    | CAV             | Computer Aided Verification                                  | A    | 会议 | 计算机科学理论                         |
...
| 13   | SPM             | Symposium on Solid and Physical Modeling                     | B    | 会议 | 计算机图形学与多媒体                   |
...
| 6    | CoNLL           | Conference on Computational Natural Language Learning        | C    | 会议 | 人工智能                               |
...
| 12   | MobiQuitous     | International Conference on Mobile and Ubiquitous Systems: Computing, Networking and Services | C    | 会议 | 人机交互与普适计算                     |
