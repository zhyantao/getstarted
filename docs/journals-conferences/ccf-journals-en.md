...
| :--- | :----------- | :----------------------------------------------------------- | :--- | :--- | :------------------------------------- |
| 1    | TOCS         | ACM Transactions on Computer Systems                         | A    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 2    | TOS          | ACM Transactions on Storage                                  | A    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 3    | TCAD         | IEEE Transactions on Computer-Aided Design of Integrated Circuits and System | A    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 4    | TC           | IEEE Transactions on Computers                               | A    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 5    | TPDS         | IEEE Transactions on Parallel and Distributed Systems        | A    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 1    | TACO         | ACM Transactions on Architecture and Code Optimization       | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 2    | TAAS         | ACM Transactions on Autonomous and Adaptive Systems          | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 3    | TODAES       | ACM Transactions on Design Automation of Electronic Systems  | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 4    | TECS         | ACM Transactions on Embedded Computing Systems               | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 5    | TRETS        | ACM Transactions on Reconfigurable Technology and Systems    | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 6    | TVLSI        | IEEE Transactions on Very Large Scale Integration (VLSI) Systems | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 7    | JPDC         | Journal of Parallel and Distributed Computing                | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 8    | JSA          | Journal of Systems Architecture: Embedded Software Design    | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 9    | PARCO        | Parallel Computing                                           | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 10   |              | Performance Evaluation: An International Journal             | B    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 1    | JETC         | ACM Journal on Emerging Technologies in Computing Systems    | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 2    |              | Concurrency and Computation: Practice and Experience         | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 3    | DC           | Distributed Computing                                        | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 4    | FGCS         | Future Generation Computer Systems                           | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 5    | TCC          | IEEE Transactions on Cloud Computing                         | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 6    | Integration  | Integration, the VLSI Journal                                | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 7    | JETTA        | Journal of Electronic Testing-Theory and Applications        | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 8    | JGC          | Journal of Grid computing                                    | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 9    | MICPRO       | Microprocessors and Microsystems: Embedded Hardware Design   | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 10   | RTS          | Real-Time Systems                                            | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 11   | TJSC         | The Journal of Supercomputing                                | C    | 期刊 | 计算机体系结构/并行与分布计算/存储系统 |
| 1    | JSAC         | IEEE Journal of Selected Areas in Communications             | A    | 期刊 | 计算机网络                             |
| 2    | TMC          | IEEE Transactions on Mobile Computing                        | A    | 期刊 | 计算机网络                             |
| 3    | TON          | IEEE/ACM Transactions on Networking                          | A    | 期刊 | 计算机网络                             |
| 1    | TOIT         | ACM Transactions on Internet Technology                      | B    | 期刊 | 计算机网络                             |
| 2    | TOMCCAP      | ACM Transactions on Multimedia Computing, Communications and Applications | B    | 期刊 | 计算机网络                             |
| 3    | TOSN         | ACM Transactions on Sensor Networks                          | B    | 期刊 | 计算机网络                             |
| 4    | CN           | Computer Networks                                            | B    | 期刊 | 计算机网络                             |
| 5    | TCOM         | IEEE Transactions on Communications                          | B    | 期刊 | 计算机网络                             |
| 6    | TWC          | IEEE Transactions on Wireless Communications                 | B    | 期刊 | 计算机网络                             |
...
| 9    | RE           | Requirements Engineering                                     | B    | 期刊 | 软件工程/系统软件/程序设计语言         |
...
| 8    | IJKM         | International Journal of Knowledge Management                | C    | 期刊 | 数据库/数据挖掘/内容检索               |
...
| 3    | TVCG         | IEEE Transactions on Visualization and Computer Graphics     | A    | 期刊 | 计算机图形学与多媒体                   |
...
| 11   | TEC          | IEEE Transactions on Evolutionary Computation                | B    | 期刊 | 人工智能                               |
...
| 27   |              | Machine Vision and Applications                              | C    | 期刊 | 人工智能                               |
...
| 15   |              | World Wide Web Journal                                       | B    | 期刊 | 交叉/综合/新兴                         |
