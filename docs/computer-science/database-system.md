...
在数据库的物理存储中，我们希望研究，如何组织数据和文件，取得一个效率和安全性兼顾的效果。

MySQL 组织文件的方式与操作系统有何不同？
MySQL 是以块为单位来存取数据（磁盘块/簇），而操作系统则是以文件的方式（FAT）来存取数据。
一个块的大小就是一个 Page。因此，如果我们想要在一个块中找到某条记录，方式就是页面基地址 +
偏移地址。

为了搞清楚，具体什么是磁盘？我们应当建立一个感官的概念：
![de](https://api2.mubu.com/v3/document_image/07f926f9-5e22-4cb0-85d8-d57f0862053c-5651252.jpg)
...
```{figure} ../_static/images/raid10.png
```
...
![de](https://api2.mubu.com/v3/document_image/094b5b90-ff12-4371-b90f-a7b2f44fe234-5651252.jpg)
...
![dd](https://api2.mubu.com/v3/document_image/e495ac9f-0687-4c2c-8924-8bf6df4cfb64-5651252.jpg)
...
隔离级别越高，数据的安全性越高，但是数据库的效率越低，如何取舍，要根据业务来定：
